  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16'>
      ...
      <Link className="logo font-bold text-lg flex justify-center items-center" href={"/"}>
        <img className='invertImg' src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmR5dG1wMHk2dWFrYnF5dGlscTk5NW8zaGc3cThlM3g0NGgxc211dyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/L3CXg9Mx6YITJK0FpG/giphy.webp" width={44} alt="" />
        <span className='text-xl md:text-base my-3 md:my-0'>Chai Express !!!</span>
      </Link>
